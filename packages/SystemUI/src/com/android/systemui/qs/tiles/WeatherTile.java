...
import com.android.systemui.kasumi.DetailedWeatherView;
import com.android.systemui.kasumi.OmniJawsClient;
...
public class WeatherTile extends QSTile<QSTile.BooleanState> implements OmniJawsClient.OmniJawsObserver {
    ...
    public Intent getLongClickIntent() {
        if (kasumiUtils.isPackageInstalled(mContext, "com.google.android.googlequicksearchbox")) {
